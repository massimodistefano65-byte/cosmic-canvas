...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "bio.sec1.p2": { it: "La mia professione di agronomo e la mia specializzazione come Garden Designer non sono ambiti scissi dalla mia dimensione artistica, ma le sue fondamenta silenziose. Nel progettare piccoli giardini moderni, spazi contemporanei e giardini zen orientati all'essenzialità, io non faccio altro che fare arte: ricerco la proporzione aurea, l'equilibrio dei vuoti e dei pieni, e la sacralità dello spazio in cui l'energia può finalmente sprigionarsi. Che io stia calibrando l'armonia minimalista di un giardino essenziale, orchestrando la vita autosufficiente di un micro-ecosistema racchiuso nel vetro di un terrario, o studiando la forza vitale di un seme, compio lo stesso identico gesto: cerco le leggi universali dell’armonia. Nel 2008 questo impulso ancestrale è tornato a divampare con una forza nuova e dirompente, trasformandosi nella necessità di dare forma visibile a ciò che normalmente rimane invisibile. Da allora, dipingo e creo a tempo pieno, vivendo l’arte come una missione e una disciplina quotidiana.", en: "My profession as an agronomist and my specialization as a Garden Designer are not fields separate from my artistic dimension, but its silent foundations. In designing small modern gardens, contemporary spaces, and zen gardens oriented towards essentiality, I am doing nothing other than making art: I search for the golden ratio, the balance of voids and solids, and the sacredness of the space in which energy can finally be released. Whether I am calibrating the minimalist harmony of an essential garden, orchestrating the self-sufficient life of a micro-ecosystem enclosed in a terrarium, or studying the life force of a seed, I perform the exact same gesture: I search for the universal laws of harmony. In 2008, this ancestral impulse returned to flare up with a new and powerful force, becoming the need to give visible form to what normally remains unseen. Since then, I have been painting and creating full-time, living art as a mission and a daily discipline." },
