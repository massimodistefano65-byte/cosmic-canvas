...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "bio.agronomo": {
    it: "La mia professione di agronomo e la mia specializzazione come Garden Designer non sono ambiti scissi dalla mia dimensione artistica, ma le sue fondamenta silenziose. Nel progettare piccoli giardini moderni, spazi contemporanei e giardini zen orientati all'essenzialità, io non faccio altro che fare arte: ricerco la proporzione aurea, l'equilibrio dei vuoti e dei pieni, e la sacralità dello spazio in cui l'energia può finalmente sprigionarsi. Che io stia calibrando l'armonia minimalista di un giardino essenziale, orchestrando la vita autosufficiente di un micro-ecosistema racchiuso nel vetro di un terrario, o studiando la forza vitale di un seme, compio lo stesso identico gesto: cerco le leggi universali dell’armonia. Nel 2008 questo impulso ancestrale è tornato a divampare con una forza nuova e dirompente, trasformandosi nella necessità assoluta di dare forma visibile alle energie immateriali. Da allora, dipingo e creo a tempo pieno, vivendo l’arte come una missione e una disciplina quotidiana.",
    en: "My profession as an agronomist and my specialization as a Garden Designer are not fields separate from my artistic dimension, but its silent foundations. In designing small modern gardens, contemporary spaces, and zen gardens oriented towards essentiality, I am doing nothing other than making art: I search for the golden ratio, the balance of voids and solids, and the sacredness of the space in which energy can finally be released. Whether I am calibrating the minimalist harmony of an essential garden, orchestrating the self-sufficient life of a micro-ecosystem enclosed in a terrarium, or studying the life force of a seed, I perform the exact same gesture: I search for the universal laws of harmony. In 2008, this ancestral impulse returned to flare up with a new and disruptive force, transforming into the absolute need to give visible form to immaterial energies. Since then, I have been painting and creating full-time, living art as a mission and a daily discipline."
  },
  "bio.heading_attrito": { it: "L’attrito tra Spirito e Materia: Il Motore dell'Ascensione", en: "The Friction between Spirit and Matter: The Engine of Ascension" },
  "bio.attrito_desc": {
    it: "Mi definisco, prima di tutto, un ricercatore. Il cuore della mia indagine risiede nell’attrito: quel conflitto fecondo, magnetico e costante tra la densità della materia e la vibrazione purissima dello spirito. Sono un’anima turbolenta, in perenne cammino tra la sofferenza del limite umano e la gioia della scoperta trascendentale. Vivo una polarità fortissima: sono radicato alla Terra, sperimento la gravità e il peso dell'essere 'terribilmente terrestre', eppure avverto una spinta verticale simmetrica e opposta, un'urgenza viscerale di ascendere e connettermi con l'infinito. Questo attrito non mi immobilizza; al contrario, è il motore immobile che genera la mia expressione creativa.\n\nQuesta tensione costante mi spinge a rifiutare i confini di un solo medium. Per me non esistono barriere o gerarchie tra la pittura materica, la fotografia e l’arte digitale. Quando incido un pannello di poliuretano, quando manipolo i pixel sullo schermo o quando scatto una fotografia, sto inseguendo la medesima rivelazione: quella luce sottile che abita dietro l’evidenza delle cose. Cerco di 'organizzare il disastro' interiore per offrire a me stesso e agli altri una forma provvisoria, ma salvifica, al mistero dell’esistenza.\n\nDefinito dalla critica come un 'demiurgo di verità intuite', adotto un approccio autenticamente alchemico. Utilizzo pigmenti, smalti, colle e materiali plastici industriali (come i foam panels) per dare vita a opere caratterizzate da una forte, quasi violenta, tridimensionalità. Questa ricerca materica scava negli archetipi del subconscio e nelle connessioni energetiche universali, unendo l'introspezione più intima a una visione cosmica e stellare.",
    en: "I define myself, first of all, as a researcher. The heart of my investigation lies in friction: that fruitful, magnetic, and constant conflict between the density of matter and the pure vibration of the spirit. I am a turbulent soul, on a perennial journey between the suffering of human limits and the joy of transcendental discovery. I live a very strong polarity: I am rooted to the Earth, I experience gravity and the weight of being 'terribly terrestrial', yet I feel a symmetrical and opposite vertical thrust, a visceral urgency to ascend and connect with the infinite. This friction does not immobilize me; on the contrary, it is the immobile engine that generates my creative expression. This constant tension pushes me to reject the boundaries of a single medium. For me, there are no barriers or hierarchies between matter painting, photography, and digital art. When I engrave a polyurethane panel, when I manipulate pixels on the screen, or when I take a photograph, I am chasing the same revelation: that subtle light that lives behind the evidence of things. I try to 'organize the interior disaster' to offer myself and others a temporary, but saving, form to the mystery of existence. Defined by critics as a 'demiurge of intuited truths', I adopt an authentically alchemical approach. I use pigments, enamels, glues, and industrial plastic materials (such as foam panels) to give life to works characterized by a strong, almost violent, three-dimensionality. This material research digs into the archetypes of the subconscious and universal energetic connections, combining the most intimate introspection with a cosmic and stellar vision."
  },
  "bio.heading_linguaggi": { it: "Geografie dell’anima: I linguaggi della mia ricerca", en: "Geographies of the Soul: The Languages of My Research" },
  "bio.list_pittura": { it: "La Pittura Materica: Aggredisco la superficie con smalti, resine e materiali di recupero. Le spaccature e i rilievi non sono incidenti, ma feritoie: cerco di far emergere la vita e la luce proprio dalle fratture e dalle stratificazioni della materia densa.", en: "Matter Painting: I attack the surface with enamels, resins, and recycled materials. The cracks and reliefs are not accidents, but slits: I try to bring out life and light precisely from the fractures and layers of dense matter." },
  "bio.list_foto": { it: "La Fotografia: È il mio strumento d'elezione per catturare il 'miracolo' nell’ordinario e l'impronta dell'eterno nel transitorio. Un battito di ciglia, l'architettura microscopica di una pianta o l'universo nascosto di un insetto diventano per me soglie spazio-temporali, portali visivi che strappano l'essenza dal frastuono del mondo. Questo sguardo analitico e profondo ha ottenuto un importante riconoscimento internazionale nel 2015, quando una mia macrofotografia è stata selezionata per la quinta edizione del prestigioso Exposure Award, venendo esposta all'interno di una mostra digitale collettiva durante un ricevimento ufficiale presso il Museo del Louvre di Parigi e inserita nel volume cartaceo della Microphotography Collection. Un traguardo che ha confermato la validità di una visione che scorge l'infinito nel dettaglio più infinitesimale.", en: "Photography: It is my chosen tool for capturing the 'miracle' in the ordinary and the imprint of the eternal in the transitory. This analytical and profound gaze obtained important international recognition in 2015, when one of my macro-photographs was selected for the fifth edition of the prestigious Exposure Award, being exhibited within a collective digital exhibition during an official reception at the Louvre Museum in Paris and included in the printed volume of the Microphotography Collection. A milestone that confirmed the validity of a vision that discerns the infinite in the most infinitesimal detail." },
  "bio.list_digital": { it: "L’Arte Digitale e gli NFT: Rappresentano l'estensione immateriale della mia ricerca, il luogo in cui mi spoglio del peso terrestre per guardare il Cosmo. Nel regno digitale il colore si fa frequenza pura, vibrazione cromatica e onda quantistica. Attraverso lo schermo traccio geografie dell’anima, flussi magnetici e connessioni energetiche che superano il piano tridimensionale.", en: "Digital Art and NFTs: They represent the immaterial extension of my research, the place where I strip off terrestrial weight to look at the Cosmos. In the digital realm, color becomes pure frequency, chromatic vibration, and quantum wave. Through the screen, I trace geographies of the soul, magnetic flows, and energetic connections that surpass the three-dimensional plane." },
  "bio.heading_tshirt": { it: "Dallo schermo al quotidiano: L'arte da indossare", en: "From the Screen to the Daily Life: Wearable Art" },
  "bio.tshirt_desc": {
    it: "Proprio partendo dalle mie opere digitali e dalle mie creazioni visive, ho sentito il desiderio di estendere questa ricerca oltre i confini tradizionali della tela o dello schermo. Ho scelto così di trasferire le mie geometrie e le mie frequenze cromatiche su supporti d'uso quotidiano, dando vita a una linea di t-shirt e oggetti d'arte in cui i miei lavori vengono riprodotti attraverso stampe d'alta qualità. Non si tratta di semplice merchandising, ma del tentativo di far uscire l'arte dagli spazi canonici per farla camminare nel mondo, trasformando un capo d'abbigliamento in un manifesto portatile del proprio mondo interiore. Questo cammino poliedrico mi ha portato a partecipare con successo a numerose mostre nazionali e concorsi internazionali, e oggi le mie opere sono presenti in collezioni fisiche e virtuali, testimoniando un’evoluzione costante nel dialogo tra arte tradizionale, nuove tecnologie e vita quotidiana.",
    en: "Starting precisely from my digital works and my visual creations, I felt the desire to extend this research beyond the traditional boundaries of the canvas or the screen. I thus chose to transfer my geometries and my chromatic frequencies onto daily use supports, giving life to a line of t-shirts and art objects in which my works are reproduced through high-quality prints. It is not simple merchandising, but an attempt to let art out of canonical spaces to make it walk in the world, transforming a piece of clothing into a portable manifesto of one's inner world. This polyhedral path has led me to successfully participate in numerous national exhibitions and international competitions, and today my works are present in physical and virtual collections, witnessing a constant evolution in the dialogue between traditional art, new technologies, and daily life."
  },
  "bio.heading_cosmo": { it: "La Visione Cosmica e il Contatto con l'Ignoto", en: "The Cosmic Vision and the Contact with the Unknown" },
  "bio.cosmo_desc": {
    it: "La mia arte è strettamente interconnessa a una spiritualità profonda, libera da dogmi o religioni precostituite, che si estende oltre i confini del nostro pianeta. Lo studio dell'universo e delle sei geometrie mi pone da sempre di fronte a un dato di fatto per me incontrovertibile: non siamo soli nell’universo. Sono un profondo fautore dell’esistenza di altre forme di vita extraterrestri e un ricercatore attivo in questo campo, guidato da importanti esperienze dirette che hanno per sempre ridefinito i confini della mia percezione. Questa consapevolezza influisce prepotentemente sulla mia produzione artistica: dipingere il cosmo, le sue frequenze e le sue intelligenze non è per me un esercizio di fantasia onirica, ma la traduzione visiva di una realtà superiore. La mia ricerca ufologica e spaziale è l'estensione naturale del mio bisogno di squarciare il velo dell'invisibile, per mappare quelle presenze e quelle energie che fluttuano oltre il nostro limitato spettro visivo.",
    en: "My art is closely interconnected with a deep spirituality, free from dogmas or pre-established religions, which extends beyond the boundaries of our planet. The study of the universe and its six geometries has always confronted me with a fact that is incontrovertible for me: we are not alone in the universe. I am a profound advocate for the existence of other forms of extraterrestrial life and an active researcher in this field, guided by important direct experiences that have forever redefined the boundaries of my perception. This awareness powerfully influences my artistic production: painting the cosmos, its frequencies, and its intelligences is not for me an exercise in dreamlike fantasy, but the visual translation of a superior reality."
  },
  "bio.heading_filosofia": { it: "La filosofia del Maestro Interiore", en: "The Philosophy of the Inner Master" },
  "bio.filosofia_desc": {
    it: "La mia pratica artistica e concettuale è indissolubilmente legata alla meditazione e allo studio profondo delle filosofie orientali. Sento con assoluta certezza che siamo esseri immortali, scintille coscienti di un’unica energia divina che regola, attraversa e unisce l’intero cosmo. Credo fermamente che la ricerca di una guida esterna sia spesso un’illusion o una delega: il 'Vero Maestro' risiede già dentro ognuno di noi. La mia arte non vuole essere decorazione, ma un dispositivo di risveglio; un invito a ritrovare quella guida interiore, a prendersi la responsabilità della propria luce e a riconoscere che la bellezza e la verità non sono traguardi lontani o conquiste future. Sono presenze che pulsano qui, ora, in questo esatto istante, in ogni battito e in ogni respiro. Le mie opere sono inviti a sostare sulle soglie invisibili, a spiare il mondo attraverso le fessure della materia e a guardare il cielo con occhi nuovi, per ricordare, finalmente, che siamo esseri immortali in cammino verso l'Origine. Oggi vivo, ricerco e creo a Sant'Egidio, vicino a Perugia, immerso nel mio laboratorio, costantemente teso tra la terra che coltivo e il cielo infinito che esploro, sempre pronto a lasciarmi stupire dal prossimo istante di luce.",
    en: "My artistic and conceptual practice is indissolubly linked to meditation and the deep study of Eastern philosophies. I feel with absolute certainty that we are immortal beings, conscious sparks of a single divine energy that regulates, traverses, and unites the entire cosmos. I firmly believe that the search for an external guide is often an illusion or a delegation: the 'True Master' already resides within each of us. My art does not want to be decoration, but a device for awakening; an invitation to rediscover that inner guide, to take responsibility for one's own light, and to recognize that we are immortal beings on a journey towards the Origin. Today I live, research, and create in Sant'Egidio, near Perugia, immersed in my laboratory, always ready to be amazed by the next moment of light."
  },
